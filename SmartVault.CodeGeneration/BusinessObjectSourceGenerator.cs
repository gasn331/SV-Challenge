...
namespace SmartVault.CodeGeneration
{
    ...
    {
        private int numberOfBusinessObjects = 4;
        public void Execute(GeneratorExecutionContext context)
        {
            ...
            for (int i = 0; i < numberOfBusinessObjects; i++)
            {
                ...
                propertiesString += $"        public DateTime CreatedOn {{ get; set; }} = DateTime.UtcNow;{Environment.NewLine}";
